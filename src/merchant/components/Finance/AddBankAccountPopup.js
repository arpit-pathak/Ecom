...
export default function AddBankAccountPopup({
    ...
    const onBankAccountAdded = (res, api) => {
        handleRefundAcceptClose();
        processAddBankAccount(res, api)
    }
        ...
        <>
            <Modal
                ...
                children={isBankListLoading ?
                    ...
                    <div>
                        <p className='text-lg font-semibold mb-3'>Add Bank Account</p>
                        <hr />
