          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                to={AdminRoutes.Landing}
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Edit your information in a swipe</span> Not in use yet.</span>
